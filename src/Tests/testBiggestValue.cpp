...
namespace{
  ...
  void validateMessage1(Messages::Message & message)
  {
    ...
    BOOST_CHECK_EQUAL(value->toUInt32(), 4294967295);
    ...
    BOOST_CHECK_EQUAL(value->toDecimal(), Decimal (9223372036854775807, 63));
    ...
    //  <decimal name="decimal_copy" id="29"><copy value="9223372036854775807000000000000000000000000000000000000000000000"/>
